 ...
 */
package modelo.dao;
//@Override: sobreescribiendo el codigo, lo de adentro se puede implementar como sea
//throw es un error autogenerado, se debe borra, si sale ese error es porque no se ha usado en metodo
